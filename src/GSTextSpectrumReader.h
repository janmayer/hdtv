...
#ifndef __GSTextSpectrumReader_h__
#define __GSTextSpectrumReader_h__

#include <Riostream.h>
#include <TH1.h>

class GSTextSpectrumReader {
 public:
  GSTextSpectrumReader(const char *fname);
  ~GSTextSpectrumReader(void);
  int GetNumLines(void);
  void ToROOT(TH1 *hist);
