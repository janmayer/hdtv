...
class Integral {
  public:
    ...
    */
    ...
    double GetIntegral();            //!< Cached version of CalcIntegral()
    double GetIntegralError();       //!< Cached version of CalcIntegralError()
    double GetMean();                //!< Cached version of CalcMean()
    double GetMeanError();           //!< Cached version of CalcMeanError()
    double GetVariance();            //!< Cached version of CalcVariance()
    double GetVarianceError();       //!< Cached version of CalcVarianceError()
    double GetRawSkewness();         //!< Cached version of CalcRawSkewness()
    double GetRawSkewnessError();    //!< Cached version of CalcRawSkewnessError()
    double GetSkewness();            //!< Cached version of CalcSkewness()
    double GetSkewnessError();       //!< Cached version of CalcSkewnessError()
