...
def SearchNuclide(nuclide):
    ...
    for tableOfEnergiesData in json.loads(tableOfEnergiesStr): 
        if tableOfEnergiesData['nuclide'] == nuclide:
            ...
            Energies = [float(data['energy']) for data in tableOfEnergiesData['transitions']]
            EnergiesError = [float(data['energy_uncertainty']) for data in tableOfEnergiesData['transitions']]
            Intensities = [float(data['intensity']) for data in tableOfEnergiesData['transitions']]
            IntensitiesError = [float(data['intensity_uncertainty']) for data in tableOfEnergiesData['transitions']]
